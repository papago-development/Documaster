...
CREATE TABLE dbo.AdditionalDocument(
	Id INT IDENTITY(1,1) NOT NULL
	,ProjectId INT NOT NULL
	,ContentType VARCHAR(200) NULL
	,[Name] NVARCHAR(100) NOT NULL
...
ALTER TABLE dbo.AdditionalDocument
ADD CONSTRAINT PK_AdditionalDocument
PRIMARY KEY CLUSTERED (Id)
GO

ALTER TABLE dbo.AdditionalDocument WITH CHECK
	ADD CONSTRAINT FK_AdditionalDocument_ProjectId_Project_Id
	FOREIGN KEY (ProjectId)
	REFERENCES dbo.Project (Id)
GO